export function unDataURI(dataURI: string) {
...
export function dataURItoArray(dataURI: any) {
  // convert base64/URLEncoded data component to raw binary data held in a string
  var byteString
  if (dataURI.split(',')[0].indexOf('base64') >= 0)
    byteString = atob(dataURI.split(',')[1])
...
export function toDataURI(data: string, filetype: string) {
...
export function blobToBase64(blob: Blob): Promise<string> {
  return new Promise((resolve, _) => {
    ...
    reader.onloadend = () =>
      reader.result &&
      // @ts-ignore We never seem to get an ArrayBufer here? TODO
