locals {
  ...
  account_id          = "126441307120"
  # TODO Cognito update for prod
  temporary_password_validity_days = 10
  support_role_arns    = ["arn:aws:iam::126441307120:user/medicapt-shared"]
  ...
  records_bucket_privileged_principal_arns = {
    "arn:aws:iam::126441307120:user/medicapt-shared" = [""]
    "arn:aws:iam::126441307120:root" = [""]
  }
