terraform {
  source = "${local.stage_vars.locals.base_source_url}//api/formdesigner/"
}
...
inputs = {
  cognito_user_pool_formdesigner_arn = dependency.cognito.outputs.cognito_user_pool_arn
