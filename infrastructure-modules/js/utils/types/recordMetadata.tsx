...
export const recordSchemaDynamoLatestPart = recordSchemaDynamoLatestToUpdatePart.extend(
  {
    PK: z
      .string()
      .nonempty()
...
export const recordSchemaDynamoLatestToUpdate = recordSchemaDynamoLatestToUpdatePart
  .merge(recordSchemaDynamoUpdate)
  .strict()
