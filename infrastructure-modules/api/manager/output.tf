output "aws_api_gateway_rest_api_manager" {
  value = aws_api_gateway_rest_api.manager
  description = "The manager gateway"
}

output "aws_api_gateway_deployment_api" {
  value = aws_api_gateway_deployment.api
  description = "The manager gateway deployment"
}
