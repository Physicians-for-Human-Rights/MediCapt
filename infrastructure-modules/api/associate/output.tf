output "aws_api_gateway_rest_api_associate" {
  value = aws_api_gateway_rest_api.associate
  description = "The associate gateway"
}

output "aws_api_gateway_deployment_api" {
  value = aws_api_gateway_deployment.api
  description = "The associate gateway deployment"
}
