output "aws_api_gateway_rest_api_formdesigner" {
  value = aws_api_gateway_rest_api.formdesigner
  description = "The formdesigner gateway"
}

output "aws_api_gateway_deployment_api" {
  value = aws_api_gateway_deployment.api
  description = "The formdesigner gateway deployment"
}
