...
const handler = async (event, context) => {
  try {
    try {
      var recordCreation = recordMetadata_1.recordMetadataSchemaByUser.parse(
    ...
    const ids = await (0, common_utils_1.machineIdToHumanId)(
      recordUUID,
      'MR',
      lambda,
    ...
    const patientId = await (0, common_utils_1.machineIdToHumanId)(
      recordUUID,
      'MP',
      lambda,
      process.env.humanid_lambda
